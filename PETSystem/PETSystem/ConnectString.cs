...
namespace PETSystem
{
    class ConnectString
    {
        ...
        //USer
        public static int UserIDforOrders;
        //Payment
        ...
        */
        //Data Source =.\\SQLEXPRESS;AttachDbFilename=|DataDirectory|\\FinaalINF370.mdf;Integrated Security = True;
        // ALMAL SE CONNECTION STRINGS

        //Jan se connection string
       
        public static string DBC = " Data Source =.\\SQLEXPRESS;AttachDbFilename=|DataDirectory|\\FinaalINF370.mdf;Integrated Security = True;";
